...
為確保-- \textbf{抬底仔(á)-Tidy UP}能如期完成，我們制定了詳細的開發時程。下表\ref{tab:schedule_v2}結合了週進度目標與具體執行清單：

\begin{table}[htbp]
    \centering
    \caption{每週預期成果與分工規劃表}
